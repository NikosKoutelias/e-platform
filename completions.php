    ...
    <div class="container" style="margin-top:5rem ;">
            ...
            <div class="col-md-12">
                ...
                <div class="row">
                    ...
                    $post_query_count = "SELECT * FROM enrolments WHERE user_id = '$user_id' AND completed = 1";
                    ...
                    if($count < 1){
                        ...
                        echo "<h3 class='col-12 text-center my-4 py-4 h3_title'>You haven&#39t Completed any Course </h3>";
                        ...
                        $query = "SELECT * FROM courses WHERE id IN $in ";
                        ...
                        <h4 class="col-12 pb-2">Total Courses Completed: <small> <?php echo $total_count;?></small></h4>
...
?>
    <div class="container" style="margin-top:5rem ;">
       ...
       <div class="col-md-12" style="box-shadow:  0px 22px 70px 4px rgba(0, 0, 0, 0.26);">
           <b><p style="font-size:20px;" class="discreption_text m-4 p-4" >You need to  <a style="font-weight:700; -webkit-text-fill-color:#133a78" href="login.php">login</a> to see your Completed Courses</p></b>
       </div>
    </div> 
<?php 
    } 
